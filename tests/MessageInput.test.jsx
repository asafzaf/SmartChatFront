...
describe("MessageInput", () => {
    ...
    test("renders input and button with correct initial state", () => {
        render(<MessageInput onSend={jest.fn()} isNewChat={false} waitingForResponse={false} />);
    ...
    test("shows 'Start Chat' when isNewChat=true", () => {
        render(<MessageInput onSend={jest.fn()} isNewChat={true} waitingForResponse={false} />);
    ...
    test("disables input and button when waitingForResponse=true", () => {
        render(<MessageInput onSend={jest.fn()} isNewChat={false} waitingForResponse={true} />);
    ...
    test("calls onSend with text and clears input on submit", () => {
        ...
        const { container } = render(<MessageInput onSend={onSendMock} isNewChat={false} waitingForResponse={false} />);
