...
describe("UserPreferencesModal", () => {
    ...
    test("shows error if updateUser returns error", async () => {
        ...
        fireEvent.click(screen.getByText("Save"));
        await waitFor(() => {
            expect(console.error).toHaveBeenCalledWith("Failed to update user:", "server error");
        });
    });
    ...
    test("catches and logs unexpected error in catch block", async () => {
        ...
        fireEvent.click(screen.getByText("Save"));
        await waitFor(() => {
            expect(console.error).toHaveBeenCalledWith("Failed to update user:", mockError);
        });
    });
    ...
    test("renders correctly when data fields are missing", () => {
        ...
        const passwordFields = screen.getAllByPlaceholderText(/keep current password/i);
