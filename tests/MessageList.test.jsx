...
describe("MessageList", () => {
  ...
  test("submits feedback form and resets state", async () => {
    ...
    const qualitativeInput = screen.getByPlaceholderText(
      /write your qualitative feedback/i
    );
  ...
  test("resets form data and updates gotFeedback after submission", async () => {
    ...
    fireEvent.change(
      screen.getByPlaceholderText(/write your qualitative feedback/i),
      {
    ...
    expect(
      screen.getByPlaceholderText(/write your qualitative feedback/i).value
    ).toBe("");
    screen
      .getAllByRole("combobox")
      .forEach((select) => expect(select.value).toBe(""));
    expect(
      screen.queryByText(/want to share feedback/i)
  ...
  test("updates interactionDetails.clarity field in formData", async () => {
    ...
    const claritySelect = allSelects.find(
      (el) => el.getAttribute("name") === "clarity"
    );
